...
{
    public interface IVialOfSpectralEssenceSpellSevice : ISpellService { }
    class VialOfSpectralEssence : SpellService, ISpellService<IVialOfSpectralEssenceSpellSevice>
    {
        ...
        public override double GetAverageRawHealing(GameState gameState, BaseSpellData spellData)
        {
            ...
            var healingPool = scaleBudget * spellData.GetEffect(871762).Coefficient;
