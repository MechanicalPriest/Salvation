...
namespace Salvation.CoreTests.HolyPriest.Spells
{
    ...
    public class DivineServiceTests : BaseTest
    {
        ...
        public void Init()
        {
            ...
            _spell = new PrayerOfMending(_gameStateService, null);
        ...
        public void GetAverageRawHealing_Talented_Ranks()
        {
            ...
            // Assert
            Assert.That(resultRank0, Is.EqualTo(10999.137937736617d));
            Assert.That(resultRank1, Is.EqualTo(12132.493554937133d));
        }
    }
}
