    ...
    public class SpellServiceTestsData
    {
        ...
        public static IEnumerable GetAverageRawHealing
        {
            get
            {
                ...
                yield return new TestCaseData(typeof(PowerWordShield)).Returns(2008.9086922800004d);
                ...
                yield return new TestCaseData(typeof(UnholyNova)).Returns(8367.1047033462019d);
        ...
        public static IEnumerable GetAverageHealing
        {
            get
            {
                ...
                yield return new TestCaseData(typeof(PowerWordShield)).Returns(1245.5233892136002d);
                ...
                yield return new TestCaseData(typeof(UnholyNova)).Returns(8283.4336563127399d);
        ...
        public static IEnumerable GetAverageDamage
        {
            get
            {
                ...
                yield return new TestCaseData(typeof(UnholyTransfusion)).Returns(3758.2487951113644d);
        ...
        public static IEnumerable GetAverageOverhealing
        {
            get
            {
                ...
                yield return new TestCaseData(typeof(PowerWordShield)).Returns(763.38530306639996d);
                ...
                yield return new TestCaseData(typeof(UnholyNova)).Returns(83.671047033500002d);
